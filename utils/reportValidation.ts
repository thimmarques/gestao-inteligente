...
export function validateReportPeriod(startDate: Date, endDate: Date): {
  isValid: boolean;
  error?: string;
  warning?: string;
} {
  ...
  if (daysDiff < 7 && daysDiff >= 0) {
    warning = 'Período muito curto selecionado. O relatório pode conter poucos dados estatísticos.';
  }
