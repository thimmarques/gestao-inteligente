        ...
        <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950 p-4 transition-colors">
            <div className="w-full max-w-md">
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-3xl font-bold dark:text-white">Recuperar Senha</h1>
                    <p className="text-slate-500 dark:text-slate-400 mt-2">Enviaremos as instruções por e-mail</p>
                </div>
                ...
                <div className="bg-white dark:bg-slate-900 p-8 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-xl">
                    {success ? (
                        <div className="text-center">
                            ...
                            <h2 className="text-xl font-bold dark:text-white mb-2">E-mail enviado!</h2>
                        ...
                        <>
                            ...
                            <form onSubmit={handleReset} className="space-y-6">
                                <div>
                                    <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">Seu e-mail de cadastro</label>
