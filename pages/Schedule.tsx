      ...
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="flex items-center px-8 py-4 bg-primary-600 hover:bg-primary-700 text-white rounded-2xl font-black shadow-xl transition-all active:scale-95 group"
          >
            <Plus
              size={20}
