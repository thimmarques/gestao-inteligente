                ...
                <div className="w-full max-w-md text-center">
                    <div className="bg-white dark:bg-slate-900 p-8 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-xl">
                        ...
                        <p className="text-slate-600 dark:text-slate-400 mb-8">
                            Enviamos um link de confirmação para <strong>{registeredEmail}</strong>. Por favor, verifique sua caixa de entrada e spam.
                        </p>
                        <Link
                            to="/login"
        ...
        <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950 p-4 transition-colors">
            <div className="w-full max-w-md">
                <div className="text-center mb-8">
                    ...
                    <p className="text-slate-500 dark:text-slate-400 mt-2">Comece sua gestão inteligente hoje</p>
                </div>
