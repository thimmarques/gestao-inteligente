        ...
        <div className="p-10 flex flex-col md:flex-row items-center gap-10 bg-slate-50/50 dark:bg-slate-800/20 border-b border-slate-100 dark:border-white/10">
          ...
          <div className="flex-1 text-center md:text-left space-y-2">
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-3">
              ...
              {isMe && (
                <span className="px-3 py-1 bg-yellow-500 text-white rounded-lg text-[10px] font-black uppercase tracking-widest shadow-lg">
                  VOCÊ
                </span>
              )}
            </div>
          ...
          <div className="animate-in fade-in duration-500">
            {activeTab === 'perfil' && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <section className="bg-primary-600 p-10 rounded-[2.5rem] text-white shadow-2xl shadow-primary-500/20 relative overflow-hidden">
                  ...
                  <h3 className="text-[10px] font-black uppercase tracking-[0.2em] opacity-60 mb-8">
            ...
            {activeTab === 'produtividade' && (
              <div className="py-20 text-center text-slate-400 italic">
                ...
                <p>
                  Gráficos de produtividade individual serão reconciliados no
                  próximo fechamento.
                </p>
              </div>
            )}
