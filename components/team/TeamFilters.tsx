    ...
    <div className="flex flex-col md:flex-row items-stretch md:items-center gap-4 py-2">
      ...
      <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="absolute top-full left-0 mt-2 w-56 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-2xl z-50 p-3 animate-in zoom-in-95">
              {['admin', 'advogado', 'assistente'].map((r) => (
                ...
                >
                  ...
                  />
                  <span className="text-xs font-black uppercase tracking-widest text-slate-600 dark:text-slate-300 group-hover:text-primary-600">
                    {r}
                  </span>
                </label>
              ))}
        ...
        {isFiltered && (
          <button
            onClick={handleClear}
            className="p-3.5 text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-2xl transition-all shadow-sm flex items-center gap-2"
          >
            <X size={20} />
