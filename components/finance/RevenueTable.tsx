          ...
          <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
            {revenues.length === 0 ? (
              <tr>
                <td
                  colSpan={7}
                  className="px-8 py-20 text-center text-slate-500 font-bold uppercase tracking-widest text-xs"
                >
              ...
              revenues.map((r) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-6 py-5">
                      <span className="text-base font-black dark:text-white tabular-nums">
