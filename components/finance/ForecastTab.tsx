    ...
    <div className="space-y-10 animate-in fade-in duration-500 pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white dark:bg-slate-900 p-8 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm">
          ...
          <p className="text-3xl font-black dark:text-white tracking-tighter tabular-nums">
            {formatCurrency(totals.revenue)}
          </p>
          <p className="text-[10px] font-bold text-primary-500 uppercase mt-2 tracking-widest">
            Acumulado semestre
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 p-8 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm">
          ...
          <p className="text-[10px] font-bold text-red-500 uppercase mt-2 tracking-widest">
            Média variável inclusa
          </p>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left">
                  ...
                  <td className="px-6 py-6">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-[10px] font-bold text-slate-400 uppercase tracking-tighter">
                        Recorrente: {formatCurrency(f.recurring_revenue)}
                      </p>
                    </div>
                  </td>
                  ...
                  <td className="px-6 py-6">
                    <div className="group relative cursor-help">
                      ...
                      <div className="absolute bottom-full left-0 mb-2 w-48 p-3 bg-slate-900 text-white text-[10px] rounded-xl opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-50 leading-relaxed shadow-2xl">
                        Nível calculado com base na proporção de receita
                        recorrente contratual sobre o total.
                      </div>
                    </div>
                  </td>
            ...
            <tfoot className="bg-slate-950 text-white font-black uppercase tracking-widest text-[10px]">
              <tr>
                <td className="px-8 py-6 rounded-bl-[2.5rem]">
                  Totais Projetados
                </td>
                ...
                <td className="px-6 py-6 text-lg tracking-tighter" colSpan={2}>
                  Saldo Acumulado: {formatCurrency(totals.balance)}
                </td>
