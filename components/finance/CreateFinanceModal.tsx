  ...
  return createPortal(
    <div className="fixed inset-0 z-[150] flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-in fade-in duration-200">
      <div className="bg-white dark:bg-navy-800/50 w-full max-w-xl rounded-[2.5rem] shadow-2xl overflow-hidden border border-slate-200 dark:border-white/10 animate-in zoom-in-95 duration-300">
        ...
        >
          <div className="grid grid-cols-2 gap-4">
            <button
              ...
              className={`flex items-center justify-center gap-3 p-4 rounded-2xl border-2 transition-all ${formData.type === 'receita' ? 'border-green-600 bg-green-50 dark:bg-green-900/20 text-green-600' : 'border-slate-50 dark:border-white/10 text-slate-400'}`}
            >
              <TrendingUp size={20} />
            ...
            <button
              ...
              className={`flex items-center justify-center gap-3 p-4 rounded-2xl border-2 transition-all ${formData.type === 'despesa' ? 'border-red-600 bg-red-50 dark:bg-red-900/20 text-red-600' : 'border-slate-50 dark:border-white/10 text-slate-400'}`}
            >
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  placeholder="0,00"
                  className="w-full pl-12 pr-4 py-3.5 bg-slate-50 dark:bg-navy-800 border-none rounded-2xl focus:ring-2 focus:ring-primary-500 dark:text-white text-sm font-bold shadow-inner outline-none transition-all"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  type="date"
                  required
                  className="w-full pl-12 pr-4 py-3.5 bg-slate-50 dark:bg-navy-800 border-none rounded-2xl focus:ring-2 focus:ring-primary-500 dark:text-white text-sm shadow-inner outline-none transition-all"
                  value={formData.date}
                  onChange={(e) =>
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <select
                className="w-full px-5 py-3.5 bg-slate-50 dark:bg-navy-800 border-none rounded-2xl focus:ring-2 focus:ring-primary-500 dark:text-white text-sm outline-none shadow-sm transition-all"
            ...
            <div className="space-y-2">
              ...
              <select
                className="w-full px-5 py-3.5 bg-slate-50 dark:bg-navy-800 border-none rounded-2xl focus:ring-2 focus:ring-primary-500 dark:text-white text-sm outline-none shadow-sm transition-all font-bold"
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="w-full px-5 py-4 bg-slate-50 dark:bg-navy-800 border-none rounded-[2rem] focus:ring-2 focus:ring-primary-500 dark:text-white text-sm resize-none shadow-inner outline-none transition-all"
        ...
        <div className="px-10 py-8 bg-slate-50 dark:bg-white/5 border-t border-slate-100 dark:border-white/10 flex justify-between items-center">
          <button
            type="button"
            onClick={onClose}
