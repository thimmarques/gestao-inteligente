...
import { X, Clock, Calendar, Download, FileText, FileSpreadsheet } from 'lucide-react';
        ...
        <div className="px-10 pt-10 pb-6 border-b border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-2xl font-black dark:text-white tracking-tight">Relatório de Prazos</h2>
                <p className="text-sm font-medium text-slate-500">Histórico e compliance judicial</p>
              </div>
            </div>
