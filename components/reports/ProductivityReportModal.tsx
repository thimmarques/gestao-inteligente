...
import { X, TrendingUp, Calendar, Check, Download, FileText, FileSpreadsheet } from 'lucide-react';
...
export const ProductivityReportModal: React.FC<ProductivityReportModalProps> = ({
        ...
        <div className="px-10 pt-10 pb-6 border-b border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-2xl font-black dark:text-white tracking-tight">Produtividade</h2>
                <p className="text-sm font-medium text-slate-500">Métricas de fluxo e vazão</p>
              </div>
            </div>
