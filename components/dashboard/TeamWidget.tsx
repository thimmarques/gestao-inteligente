    ...
    <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] p-8 border border-slate-200 dark:border-slate-800 shadow-sm h-[320px] flex flex-col group">
      <header className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-black dark:text-white uppercase tracking-widest text-slate-800 dark:text-slate-100">Time Jurídico</h3>
        ...
        {isLoading ? (
          ...
          activeMembers.slice(0, 5).map((m) => (
            <button
              ...
              className="w-full flex items-center justify-between p-2 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-2xl transition-all border border-transparent hover:border-slate-100 dark:hover:border-slate-700 text-left"
            >
              <div className="flex items-center gap-3">
