      ...
      <div className="bg-white dark:bg-navy-800/50 w-full max-w-md rounded-3xl shadow-2xl overflow-hidden border border-slate-200 dark:border-white/10 animate-in zoom-in-95 duration-300">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          <div className="space-y-1">
            ...
            <div className="flex items-center gap-2 p-3 bg-slate-50 dark:bg-navy-800 rounded-xl border border-slate-100 dark:border-white/15 text-slate-500 cursor-not-allowed">
              <Lock size={14} />
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full px-4 py-2.5 bg-slate-50 dark:bg-navy-800 border-none rounded-xl focus:ring-2 focus:ring-primary-500 dark:text-white text-sm"
          ...
          <div className="space-y-1">
            ...
            <textarea
              ...
              className="w-full px-4 py-2.5 bg-slate-50 dark:bg-navy-800 border-none rounded-xl focus:ring-2 focus:ring-primary-500 dark:text-white text-sm resize-none"
