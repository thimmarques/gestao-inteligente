...
const colorMap = {
  ...
  green: 'text-green-600 bg-green-600/10 dark:text-green-400 dark:bg-green-400/10',
  orange: 'text-orange-600 bg-orange-600/10 dark:text-orange-400 dark:bg-orange-400/10',
  ...
  return (
    <div className="bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-200 group">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className={`w-10 h-10 rounded-2xl flex items-center justify-center transition-transform group-hover:scale-110 ${colorClasses}`}>
          {icon}
        </div>
      </div>
      ...
      {trend && (
        <div className="mt-4 flex items-center gap-1.5">
          <div className={`flex items-center gap-0.5 text-sm font-bold ${trend.isPositive ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
