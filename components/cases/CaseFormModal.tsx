...
export const CaseFormModal: React.FC<CaseFormModalProps> = ({ isOpen, onClose, onSave, initialData }) => {
        ...
        <form onSubmit={handleSubmit} className="flex flex-col h-full overflow-hidden">
          <div className="px-8 py-6 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between shrink-0">
            <div>
              ...
              <p className="text-sm text-slate-500">Insira os detalhes do caso (todos os campos opcionais).</p>
            </div>
            <button 
              type="button" 
              onClick={onClose} 
          ...
          <div className="p-8 overflow-y-auto space-y-8 scrollbar-hide">
            <section className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-1">
                  <label htmlFor="client_id" className="text-sm font-bold dark:text-slate-300 block">Cliente</label>
                  <select 
                    id="client_id"
                    ref={firstInputRef}
                ...
                <div className="space-y-1">
                  <label htmlFor="process_number" className="text-sm font-bold dark:text-slate-300 block">Número do Processo (CNJ)</label>
                  <input 
                    id="process_number"
                    type="text" 
                ...
                <div className="md:col-span-2 space-y-1">
                  <label htmlFor="court" className="text-sm font-bold dark:text-slate-300 block">Tribunal e Vara</label>
                  <input 
                    id="court"
                    type="text" 
            ...
            <section className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  <label htmlFor="type" className="text-sm font-bold dark:text-slate-300 block mb-1">Área</label>
                  <select 
                    id="type"
                    value={formData.type}
                ...
                <div>
                  <label htmlFor="status" className="text-sm font-bold dark:text-slate-300 block mb-1">Status</label>
                  <select 
                    id="status"
                ...
                <div>
                  <label htmlFor="value" className="text-sm font-bold dark:text-slate-300 block mb-1">Valor da Causa (R$)</label>
                  <input 
                    id="value"
                    type="number" 
                    placeholder="0.00"
            ...
            <section className="space-y-4">
              <label htmlFor="tags-input" className="text-sm font-bold dark:text-slate-300 block flex items-center gap-2">
              ...
              <div className="flex flex-wrap gap-2 p-3 bg-slate-50 dark:bg-slate-800 rounded-2xl border-2 border-transparent focus-within:border-primary-500 transition-all">
                {formData.tags.map(tag => (
                  <span key={tag} className="px-3 py-1 bg-primary-600 text-white rounded-lg text-xs font-bold flex items-center gap-1 animate-in zoom-in duration-200">
                    {tag}
            ...
            <section className="space-y-1">
              <label htmlFor="notes" className="text-sm font-bold dark:text-slate-300 block">Observações e Notas</label>
              <textarea 
                id="notes"
                rows={4}
