  ...
  return (
    <div className="min-h-screen flex bg-slate-50 dark:bg-slate-950 font-sans selection:bg-primary-500/30">
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden relative">
        <header className="absolute top-0 left-0 right-0 h-20 flex items-center justify-between px-8 bg-white/60 dark:bg-slate-950/60 backdrop-blur-md border-b border-slate-200/50 dark:border-slate-800/50 shrink-0 z-30 transition-all duration-300">
          ...
          <div className="flex items-center gap-3 ml-auto">
            ...
            <button
              ...
              className="p-2.5 text-slate-500 dark:text-slate-400 hover:bg-white dark:hover:bg-slate-800 hover:text-amber-500 dark:hover:text-amber-400 hover:shadow-md hover:shadow-slate-200/50 dark:hover:shadow-none rounded-xl transition-all duration-300 active:scale-95"
            >
        ...
        <div className="flex-1 overflow-y-auto pt-20 custom-scrollbar p-0 bg-slate-50/50 dark:bg-slate-950">
          {children}
        </div>
      </main>
    </div>
